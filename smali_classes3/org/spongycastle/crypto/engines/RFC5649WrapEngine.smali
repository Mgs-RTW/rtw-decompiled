...
.method private rfc3394UnwrapNoIvCheck([BII)[B
    ...
    invoke-interface {v1, v10, v2}, Lorg/spongycastle/crypto/BlockCipher;->init(ZLorg/spongycastle/crypto/CipherParameters;)V
    ...
    invoke-interface {v12, v8, v10, v8, v10}, Lorg/spongycastle/crypto/BlockCipher;->processBlock([BI[BI)I
    ...
    .line 295
    :cond_2
    iput-object v7, v0, Lorg/spongycastle/crypto/engines/RFC5649WrapEngine;->extractedAIV:[B
