...
.method public check(Ljava/lang/String;Lcom/netease/download/config/ConfigParams;Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-virtual {p1}, Lcom/netease/download/check/BackUpIpProxy;->getHistoryTopSpeed()J
    ...
    invoke-virtual {p1, p3, p4, v2, v3}, Lcom/netease/download/check/BackUpIpProxy;->setBackUpInfo(Ljava/lang/String;Ljava/lang/String;J)V
    ...
    invoke-virtual {p1, v1}, Lcom/netease/download/check/BackUpIpProxy;->setBackUpIpStatus(I)V

    if-nez p5, :cond_0

    const-string p1, "CheckTime"
    ...
    invoke-static {p1, p5}, Lcom/netease/download/util/LogUtil;->i(Ljava/lang/String;Ljava/lang/String;)V

    .line 105
    :cond_0
    sget-wide v4, Lcom/netease/download/check/CheckTime;->mTopSpeed:J

    iget p1, p2, Lcom/netease/download/config/ConfigParams;->mRemoveSlowCDNPercent:I
