...
.method public reportFinish()V
    ...
    sget v1, Lcom/netease/download/listener/DownloadListenerProxy;->mTotalFileCount:I
    ...
    invoke-virtual {v0, v1, v2, v3}, Lcom/netease/download/downloader/TaskHandleOp;->addTaskFailCodeCountMap(IJ)V
    ...
    invoke-virtual {v0, v1}, Lcom/netease/download/reporter/ReportProxy;->setmReportCallBack(Lcom/netease/download/reporter/ReportCallBack;)V
    ...
    const-string v7, "__DOWNLOAD_END__"
    ...
    .line 448
    sget-wide v2, Lcom/netease/download/listener/DownloadListenerProxy;->mHasDownloadSize:J

    div-long/2addr v2, v0

    :cond_1
    const-string v4, "InnerDownloadHandler"
