...
.method static change(Landroid/content/Context;)V
    ...
    const-string v8, "__DOWNLOAD_NETWORK_LOST__"
    ...
    invoke-virtual {v12}, Lcom/netease/download/downloader/TaskHandle;->getDownloadId()Ljava/lang/String;
    ...
    invoke-virtual {v13}, Lcom/netease/download/downloader/TaskHandle;->getNtesOrbitId()Ljava/lang/String;
    ...
    invoke-virtual {v2, v1}, Lcom/netease/download/downloader/TaskHandle;->setNetworkLost(I)V
    ...
    const-string v2, "\u8fde\u63a5\u7684\u662fWIFI\u7f51\u7edc"

    .line 57
    invoke-static {p0, v2}, Lcom/netease/download/util/LogUtil;->i(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v4, "\u6ca1\u6709\u7f51\u7edc\u8fde\u63a5,\u505c\u6b62\u6389\u6240\u6709\u4efb\u52a1"
    ...
    invoke-virtual {v2, v4}, Lcom/netease/download/network/NetController;->setInterruptedCode(I)V
    ...
    invoke-virtual {v0, v3}, Lcom/netease/download/network/NetController;->setInterruptedCode(I)V
    ...
    invoke-virtual {v0, v1}, Lcom/netease/download/downloader/TaskHandle;->setNetworkSwitch(I)V
...
.method private static getNetworkInfo(Landroid/content/Context;)Landroid/net/NetworkInfo;
    ...
    const-string v3, "NetworkStatus [getNetworkInfo]= "
