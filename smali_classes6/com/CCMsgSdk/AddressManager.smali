...
.method private queryAddressListInSubThread()V
    ...
    .line 105
    :try_start_0
    iget-object v2, p0, Lcom/CCMsgSdk/AddressManager;->mConfigUrl:Ljava/lang/String;

    if-nez v2, :cond_0

    const-string v2, "http://api.cc.163.com/v1/distroommsg/serviceip"
    ...
    .line 110
    invoke-static {v1}, Lcom/CCMsgSdk/AddressManager;->inputStream2String(Ljava/io/InputStream;)Ljava/lang/String;
    ...
    .line 113
    invoke-direct {p0, v1}, Lcom/CCMsgSdk/AddressManager;->handleHttpResponse(Ljava/lang/String;)V
    :try_end_1
    ...
    .line 118
    iget-object v1, p0, Lcom/CCMsgSdk/AddressManager;->mListener:Lcom/CCMsgSdk/AddressManager$AddressListener;
    ...
    invoke-interface {v1, v0}, Lcom/CCMsgSdk/AddressManager$AddressListener;->onGetAddress(Z)V
    :try_end_2
