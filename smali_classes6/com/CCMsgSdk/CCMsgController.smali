...
.method public constructor <init>()V
    ...
    .line 90
    iget-object v0, p0, Lcom/CCMsgSdk/CCMsgController;->mThread:Lcom/CCMsgSdk/CCMsgController$LooperThread;
...
.method private createWebSocketClient()V
    ...
    const-string v1, "ws://%s/websocket"
    ...
    invoke-virtual {v0}, Lcom/JavaWebsocket/client/WebSocketClient;->connect()V
    :try_end_0
...
.method private handleServerMessage(Ljava/lang/String;)V
    ...
    const-string v3, "[CCMsgSdk]"

    const-string v4, "handleServerMessage %s"
    ...
    const-string v3, "handleServerMessage %s"
    ...
    const-string v4, "server message error, %s"
...
.method private reconnectInRandomInterval(Ljava/lang/String;)V
    ...
    const-string v3, "%s, reconnect in %d ms"
    ...
    invoke-direct {p0, v2, v3}, Lcom/CCMsgSdk/CCMsgController;->pushErrorMessage(Ljava/lang/String;Ljava/lang/String;)V

    const-string v2, "[CCMsgSdk]"

    const-string v3, "reconnect: %dth, %s"

    .line 458
    new-array v4, v4, [Ljava/lang/Object;

    iget v5, p0, Lcom/CCMsgSdk/CCMsgController;->mRejoinTimes:I
