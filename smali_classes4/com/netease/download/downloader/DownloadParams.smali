...
.method public static createParamsArray(Landroid/content/Context;Lorg/json/JSONObject;Lcom/netease/download/listener/DownloadListener;)Ljava/util/List;
    ...
    invoke-virtual {v2, v3}, Lcom/netease/download/listener/DownloadListenerProxy;->init(Lcom/netease/download/listener/DownloadListener;)V
    ...
    invoke-virtual {v2, v0, v3}, Lcom/netease/download/reporter/ReportProxy;->report(Landroid/content/Context;I)V
    ...
    .line 603
    new-instance v11, Lcom/netease/download/downloader/DownloadParams;

    invoke-direct {v11}, Lcom/netease/download/downloader/DownloadParams;-><init>()V
    ...
    :cond_1
    :goto_2
    invoke-virtual {v11, v8}, Lcom/netease/download/downloader/DownloadParams;->setIsParted(Z)V

    .line 622
    invoke-virtual {v11, v3}, Lcom/netease/download/downloader/DownloadParams;->setIsUiCallback(Z)V
    ...
    invoke-virtual {v11, v0}, Lcom/netease/download/downloader/DownloadParams;->setTargetUrl(Ljava/lang/String;)V

    .line 634
    invoke-virtual {v11}, Lcom/netease/download/downloader/DownloadParams;->getTargetUrl()Ljava/lang/String;

    move-result-object v0

    invoke-static {v0}, Lcom/netease/download/util/Util;->getCdnChannel(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    invoke-virtual {v11, v0}, Lcom/netease/download/downloader/DownloadParams;->setmChannel(Ljava/lang/String;)V
    ...
    invoke-virtual {v11, v0}, Lcom/netease/download/downloader/DownloadParams;->setFilePath(Ljava/lang/String;)V
    ...
    invoke-virtual {v11, v0}, Lcom/netease/download/downloader/DownloadParams;->setmUrlResName(Ljava/lang/String;)V
    ...
    invoke-virtual {v11, v0}, Lcom/netease/download/downloader/DownloadParams;->setOriginUrl(Ljava/lang/String;)V
    ...
    invoke-virtual {v11, v0}, Lcom/netease/download/downloader/DownloadParams;->setUrlPrefix(Ljava/lang/String;)V
    ...
    const-string v14, "\u53c2\u6570\u9009\u62e9first last\u65b9\u5f0f\uff0c\u5ffd\u7565size\u5b57\u6bb5"

    .line 642
    invoke-static {v0, v14}, Lcom/netease/download/util/LogUtil;->i(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v11, v14, v15}, Lcom/netease/download/downloader/DownloadParams;->setStart(J)V
    ...
    invoke-virtual {v11, v14, v15}, Lcom/netease/download/downloader/DownloadParams;->setLast(J)V

    .line 647
    invoke-virtual {v11}, Lcom/netease/download/downloader/DownloadParams;->getLast()J

    move-result-wide v14

    invoke-virtual {v11}, Lcom/netease/download/downloader/DownloadParams;->getStart()J
    ...
    const-string v14, "\u53c2\u6570\u9009\u62e9size\u65b9\u5f0f\uff0c\u5ffd\u7565first last\u5b57\u6bb5"
    ...
    invoke-static {v0, v8}, Lcom/netease/download/util/LogUtil;->i(Ljava/lang/String;Ljava/lang/String;)V

    .line 666
    invoke-virtual {v11, v12, v13}, Lcom/netease/download/downloader/DownloadParams;->setSize(J)V
    ...
    invoke-virtual {v11, v0}, Lcom/netease/download/downloader/DownloadParams;->setMd5(Ljava/lang/String;)V
    ...
    invoke-virtual {v11, v0}, Lcom/netease/download/downloader/DownloadParams;->setFileId(Ljava/lang/String;)V
    ...
    invoke-virtual {v11}, Lcom/netease/download/downloader/DownloadParams;->toString()Ljava/lang/String;
    ...
    invoke-virtual {v0, v5, v6}, Lcom/netease/download/downloader/TaskHandle;->setTaskAllSizes(J)V

    .line 680
    invoke-static {}, Lcom/netease/download/listener/DownloadListenerProxy;->getInstances()Lcom/netease/download/listener/DownloadListenerProxy;

    invoke-static {v5, v6}, Lcom/netease/download/listener/DownloadListenerProxy;->setmTotalSize(J)V
...
.method public getDownloadUrl()Ljava/lang/String;
    ...
    invoke-static {v0, v1, v2}, Lcom/netease/download/util/Util;->replaceDomainWithIpAddr(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
