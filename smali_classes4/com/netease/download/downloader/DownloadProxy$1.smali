...
.method public run()V
    ...
    iget-object v3, v0, Lcom/netease/download/downloader/DownloadProxy$1;->val$paramsJson:Lorg/json/JSONObject;

    invoke-static {v2, v3}, Lcom/netease/download/downloader/DownloadProxy;->access$300(Lcom/netease/download/downloader/DownloadProxy;Lorg/json/JSONObject;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v1, v2, v3}, Lcom/netease/download/reporter/ReportProxy;->report(Landroid/content/Context;I)V
    ...
    invoke-virtual {v1, v2}, Lcom/netease/download/reporter/ReportProxy;->init(Landroid/content/Context;)V
    ...
    iget-object v2, v0, Lcom/netease/download/downloader/DownloadProxy$1;->val$pListener:Lcom/netease/download/listener/DownloadListener;

    invoke-static {v1, v2}, Lcom/netease/download/downloader/DownloadProxy;->access$402(Lcom/netease/download/downloader/DownloadProxy;Lcom/netease/download/listener/DownloadListener;)Lcom/netease/download/listener/DownloadListener;
    ...
    invoke-virtual {v3}, Lcom/netease/download/downloader/TaskHandle;->getNotUseCdn()Ljava/lang/String;
    ...
    const-string v3, "DownloadProxy [asyncDownloadArray] 111"
    ...
    const-string v3, "DownloadProxy [asyncDownloadArray] 222"
    ...
    const-string v3, "DownloadProxy [asyncDownloadArray] \u5217\u8868\u6587\u4ef6\u4e0b\u8f7d"
    ...
    invoke-virtual {v1, v2, v3}, Lcom/netease/download/downloader/DownloadPreHandler;->init(Landroid/content/Context;Ljava/lang/String;)V
    ...
    const-string v3, "DownloadProxy [asyncDownloadArray] mParamsList params error"
    ...
    invoke-virtual {v1, v2}, Lcom/netease/download/reporter/ReportProxy;->setOpen(Z)V
    ...
    invoke-virtual {v11}, Lcom/netease/download/downloader/TaskHandle;->getNtesOrbitId()Ljava/lang/String;
    ...
    const-string v10, "__DOWNLOAD_STORAGE_ERROR__"
    ...
    invoke-virtual/range {v4 .. v16}, Lcom/netease/download/listener/DownloadListenerProxy$DownloadListenerHandler;->sendFinishMsg(IJJLjava/lang/String;Ljava/lang/String;[BLjava/lang/String;Ljava/lang/String;J)V
    ...
    const-string v9, "__DOWNLOAD_PARAM_ERROR__"
