...
.method static constructor <clinit>()V
    ...
    .line 53
    sget-object v0, Lcom/JavaWebsocket/WebSocketImpl;->defaultdraftlist:Ljava/util/List;
...
.method public constructor <init>(Lcom/JavaWebsocket/WebSocketListener;Ljava/util/List;)V
    ...
    .line 111
    check-cast v0, Lcom/JavaWebsocket/drafts/Draft;
...
.method private decodeFrames(Ljava/nio/ByteBuffer;)V
    ...
    .line 359
    iget-object v1, p0, Lcom/JavaWebsocket/WebSocketImpl;->current_continuous_frame_opcode:Lcom/JavaWebsocket/framing/Framedata$Opcode;
...
.method private decodeHandshake(Ljava/nio/ByteBuffer;)Z
    ...
    .line 214
    :try_start_4
    iget-object v7, p0, Lcom/JavaWebsocket/WebSocketImpl;->role:Lcom/JavaWebsocket/WebSocket$Role;

    invoke-virtual {v4, v7}, Lcom/JavaWebsocket/drafts/Draft;->setParseMode(Lcom/JavaWebsocket/WebSocket$Role;)V
    ...
    .line 217
    instance-of v8, v7, Lcom/JavaWebsocket/handshake/ClientHandshake;
    ...
    .line 218
    invoke-virtual {p0, v6, v4, v1}, Lcom/JavaWebsocket/WebSocketImpl;->flushAndClose(ILjava/lang/String;Z)V

    return v1

    .line 221
    :cond_4
    check-cast v7, Lcom/JavaWebsocket/handshake/ClientHandshake;

    .line 222
    invoke-virtual {v4, v7}, Lcom/JavaWebsocket/drafts/Draft;->acceptHandshakeAsServer(Lcom/JavaWebsocket/handshake/ClientHandshake;)Lcom/JavaWebsocket/drafts/Draft$HandshakeState;

    move-result-object v8

    .line 223
    sget-object v9, Lcom/JavaWebsocket/drafts/Draft$HandshakeState;->MATCHED:Lcom/JavaWebsocket/drafts/Draft$HandshakeState;

    if-ne v8, v9, :cond_3

    .line 224
    invoke-interface {v7}, Lcom/JavaWebsocket/handshake/ClientHandshake;->getResourceDescriptor()Ljava/lang/String;

    move-result-object v8

    iput-object v8, p0, Lcom/JavaWebsocket/WebSocketImpl;->resourceDescriptor:Ljava/lang/String;
    :try_end_4
    .catch Lcom/JavaWebsocket/exceptions/InvalidHandshakeException; {:try_start_4 .. :try_end_4} :catch_1
    ...
    invoke-interface {v8, p0, v4, v7}, Lcom/JavaWebsocket/WebSocketListener;->onWebsocketHandshakeReceivedAsServer(Lcom/JavaWebsocket/WebSocket;Lcom/JavaWebsocket/drafts/Draft;Lcom/JavaWebsocket/handshake/ClientHandshake;)Lcom/JavaWebsocket/handshake/ServerHandshakeBuilder;
    ...
    .line 236
    :try_start_6
    invoke-virtual {v4, v7, v8}, Lcom/JavaWebsocket/drafts/Draft;->postProcessHandshakeResponseAsServer(Lcom/JavaWebsocket/handshake/ClientHandshake;Lcom/JavaWebsocket/handshake/ServerHandshakeBuilder;)Lcom/JavaWebsocket/handshake/HandshakeBuilder;

    move-result-object v8

    iget-object v9, p0, Lcom/JavaWebsocket/WebSocketImpl;->role:Lcom/JavaWebsocket/WebSocket$Role;

    invoke-virtual {v4, v8, v9}, Lcom/JavaWebsocket/drafts/Draft;->createHandshake(Lcom/JavaWebsocket/handshake/Handshakedata;Lcom/JavaWebsocket/WebSocket$Role;)Ljava/util/List;

    move-result-object v8

    invoke-direct {p0, v8}, Lcom/JavaWebsocket/WebSocketImpl;->write(Ljava/util/List;)V

    .line 237
    iput-object v4, p0, Lcom/JavaWebsocket/WebSocketImpl;->draft:Lcom/JavaWebsocket/drafts/Draft;

    .line 238
    invoke-direct {p0, v7}, Lcom/JavaWebsocket/WebSocketImpl;->open(Lcom/JavaWebsocket/handshake/Handshakedata;)V
    ...
    .line 232
    iget-object v7, p0, Lcom/JavaWebsocket/WebSocketImpl;->wsl:Lcom/JavaWebsocket/WebSocketListener;

    invoke-interface {v7, p0, v4}, Lcom/JavaWebsocket/WebSocketListener;->onWebsocketError(Lcom/JavaWebsocket/WebSocket;Ljava/lang/Exception;)V
    ...
    invoke-virtual {p0, v7, v4, v1}, Lcom/JavaWebsocket/WebSocketImpl;->flushAndClose(ILjava/lang/String;Z)V
    :try_end_6
    ...
    .line 246
    invoke-virtual {p0, v6, v2}, Lcom/JavaWebsocket/WebSocketImpl;->close(ILjava/lang/String;)V
    ...
    .line 253
    invoke-virtual {p0, v6, v2, v1}, Lcom/JavaWebsocket/WebSocketImpl;->flushAndClose(ILjava/lang/String;Z)V
    ...
    invoke-virtual {v4, v7, v2}, Lcom/JavaWebsocket/drafts/Draft;->acceptHandshakeAsClient(Lcom/JavaWebsocket/handshake/ClientHandshake;Lcom/JavaWebsocket/handshake/ServerHandshake;)Lcom/JavaWebsocket/drafts/Draft$HandshakeState;
    ...
    :try_end_7
    .catch Lcom/JavaWebsocket/exceptions/InvalidHandshakeException; {:try_start_7 .. :try_end_7} :catch_6
    ...
    :try_end_8
    .catch Lcom/JavaWebsocket/exceptions/InvalidDataException; {:try_start_8 .. :try_end_8} :catch_5
