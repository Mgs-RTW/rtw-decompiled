...
.method public report(Landroid/content/Context;Ljava/lang/String;I)V
    ...
    :cond_1
    const-string p1, "ReportProxy"

    const-string v0, "ReportProxy [report] \u91c7\u7528hardcode ip"
    ...
    const-string v0, "https://sigma-orbit-impression.proxima.nie.easebar.com/sdk"
    ...
    invoke-virtual {v1, v0, p1}, Lcom/netease/download/reporter/ReportUrlController;->init(Ljava/lang/String;[Ljava/lang/String;)V
    ...
    const-string p2, "ReportProxy [report] \u65e5\u5fd7\u4e0a\u4f20\u6a21\u5757---\u4e0a\u4f20\u4fe1\u606f\uff0c\u4e0d\u9700\u8981\u4e0a\u4f20"
...
.method public reportInfo(Landroid/content/Context;II)V
    ...
    const-string p2, "ReportProxy"

    const-string v1, "ReportProxy [report] \u65e5\u5fd7\u4e0a\u4f20\u6a21\u5757---\u4e0a\u4f20\u57fa\u7840\u4fe1\u606f"
    ...
    const-string v0, "ReportProxy [report] \u65e5\u5fd7\u4e0a\u4f20\u6a21\u5757---\u4e0a\u4f20\u5168\u90e8\u4fe1\u606f"
