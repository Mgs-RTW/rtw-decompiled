...
.method public parse(Ljava/lang/String;)Lio/jsonwebtoken/Jwt;
    ...
    .line 306
    iget-object p1, p0, Lio/jsonwebtoken/impl/DefaultJwtParser;->base64UrlDecoder:Lio/jsonwebtoken/io/Decoder;

    invoke-interface {p1, v8}, Lio/jsonwebtoken/io/Decoder;->decode(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 308
    invoke-virtual {p0, v1}, Lio/jsonwebtoken/impl/DefaultJwtParser;->readValue(Ljava/lang/String;)Ljava/util/Map;
    ...
    .line 320
    :goto_6
    iget-object v2, p0, Lio/jsonwebtoken/impl/DefaultJwtParser;->base64UrlDecoder:Lio/jsonwebtoken/io/Decoder;

    invoke-interface {v2, v7}, Lio/jsonwebtoken/io/Decoder;->decode(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {p1, v2, v5}, Ljava/lang/String;-><init>([BLjava/nio/charset/Charset;)V
    ...
    invoke-direct {v5, v2}, Lio/jsonwebtoken/impl/DefaultClaims;-><init>(Ljava/util/Map;)V
    ...
    .line 341
    invoke-interface {v2}, Lio/jsonwebtoken/JwsHeader;->getAlgorithm()Ljava/lang/String;
    ...
    invoke-interface {v6, v2, v5}, Lio/jsonwebtoken/SigningKeyResolver;->resolveSigningKey(Lio/jsonwebtoken/JwsHeader;Lio/jsonwebtoken/Claims;)Ljava/security/Key;
    ...
    invoke-interface {v6, v2, p1}, Lio/jsonwebtoken/SigningKeyResolver;->resolveSigningKey(Lio/jsonwebtoken/JwsHeader;Ljava/lang/String;)Ljava/security/Key;
    ...
    .line 378
    invoke-virtual {v3}, Lio/jsonwebtoken/SignatureAlgorithm;->isHmac()Z

    move-result v2

    const-string v6, "Key bytes can only be specified for HMAC signatures. Please specify a PublicKey or PrivateKey instance."

    invoke-static {v2, v6}, Lio/jsonwebtoken/lang/Assert;->isTrue(ZLjava/lang/String;)V
    ...
    invoke-direct {v6, v11, v2}, Ljavax/crypto/spec/SecretKeySpec;-><init>([BLjava/lang/String;)V

    :cond_13
    const-string v2, "A signing key must be specified if the specified JWT is digitally signed."

    .line 385
    invoke-static {v6, v2}, Lio/jsonwebtoken/lang/Assert;->notNull(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    .line 392
    :try_start_0
    invoke-virtual {v3, v6}, Lio/jsonwebtoken/SignatureAlgorithm;->assertValidVerificationKey(Ljava/security/Key;)V

    .line 393
    invoke-virtual {p0, v3, v6}, Lio/jsonwebtoken/impl/DefaultJwtParser;->createSignatureValidator(Lio/jsonwebtoken/SignatureAlgorithm;Ljava/security/Key;)Lio/jsonwebtoken/impl/crypto/JwtSignatureValidator;
    ...
    .line 408
    invoke-interface {v7, v2, v0}, Lio/jsonwebtoken/impl/crypto/JwtSignatureValidator;->isValid(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v2, "algorithm, but the specified signing key of type "
    ...
    const-string v0, " signatures.  Because the specified "

    invoke-virtual {v1, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v0, "signing key reflects a specific and expected algorithm, and the JWT does not reflect "

    invoke-virtual {v1, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string/jumbo v0, "this algorithm, it is likely that the JWT was not expected and therefore should not be "

    invoke-virtual {v1, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string/jumbo v0, "trusted.  Another possibility is that the parser was configured with the incorrect "

    invoke-virtual {v1, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v0, "signing key, but this cannot be assumed for security reasons."
    ...
    .line 420
    iget-object v2, p0, Lio/jsonwebtoken/impl/DefaultJwtParser;->clock:Lio/jsonwebtoken/Clock;
    ...
    .line 431
    :cond_19
    invoke-static {v3, v4}, Lio/jsonwebtoken/lang/DateFormats;->formatIso8601(Ljava/util/Date;Z)Ljava/lang/String;
    ...
    iget-wide v3, p0, Lio/jsonwebtoken/impl/DefaultJwtParser;->allowedClockSkewMillis:J
    ...
    invoke-direct {v2, v1, p1, v0}, Lio/jsonwebtoken/impl/DefaultJws;-><init>(Lio/jsonwebtoken/JwsHeader;Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-direct {v0, v1, p1}, Lio/jsonwebtoken/impl/DefaultJwt;-><init>(Lio/jsonwebtoken/Header;Ljava/lang/Object;)V
