.class public Lcom/netease/ntunisdk/glide/load/resource/drawable/ResourceDrawableDecoder;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/netease/ntunisdk/glide/load/resource/drawable/ResourceDrawableDecoder;->context:Landroid/content/Context;
...
.method private findContextForPackage(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Context;
    ...
    .line 73
    iget-object v0, p0, Lcom/netease/ntunisdk/glide/load/resource/drawable/ResourceDrawableDecoder;->context:Landroid/content/Context;
    ...
    .line 74
    iget-object p1, p0, Lcom/netease/ntunisdk/glide/load/resource/drawable/ResourceDrawableDecoder;->context:Landroid/content/Context;
    ...
    .line 81
    iget-object v1, p0, Lcom/netease/ntunisdk/glide/load/resource/drawable/ResourceDrawableDecoder;->context:Landroid/content/Context;
...
.method private findResourceIdFromUri(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    .line 94
    invoke-direct {p0, p1, p2}, Lcom/netease/ntunisdk/glide/load/resource/drawable/ResourceDrawableDecoder;->findResourceIdFromTypeAndNameResourceUri(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    .line 96
    invoke-direct {p0, p2}, Lcom/netease/ntunisdk/glide/load/resource/drawable/ResourceDrawableDecoder;->findResourceIdFromResourceIdUri(Landroid/net/Uri;)I
...
.method public decode(Landroid/net/Uri;IILcom/netease/ntunisdk/glide/load/Options;)Lcom/netease/ntunisdk/glide/load/engine/Resource;
    ...
    .line 63
    invoke-direct {p0, p1, p2}, Lcom/netease/ntunisdk/glide/load/resource/drawable/ResourceDrawableDecoder;->findContextForPackage(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Context;

    move-result-object p2

    .line 64
    invoke-direct {p0, p2, p1}, Lcom/netease/ntunisdk/glide/load/resource/drawable/ResourceDrawableDecoder;->findResourceIdFromUri(Landroid/content/Context;Landroid/net/Uri;)I

    move-result p1

    .line 66
    iget-object p3, p0, Lcom/netease/ntunisdk/glide/load/resource/drawable/ResourceDrawableDecoder;->context:Landroid/content/Context;

    invoke-static {p3, p2, p1}, Lcom/netease/ntunisdk/glide/load/resource/drawable/DrawableDecoderCompat;->getDrawable(Landroid/content/Context;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method public bridge synthetic decode(Ljava/lang/Object;IILcom/netease/ntunisdk/glide/load/Options;)Lcom/netease/ntunisdk/glide/load/engine/Resource;
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/netease/ntunisdk/glide/load/resource/drawable/ResourceDrawableDecoder;->decode(Landroid/net/Uri;IILcom/netease/ntunisdk/glide/load/Options;)Lcom/netease/ntunisdk/glide/load/engine/Resource;
...
.method public bridge synthetic handles(Ljava/lang/Object;Lcom/netease/ntunisdk/glide/load/Options;)Z
    ...
    invoke-virtual {p0, p1, p2}, Lcom/netease/ntunisdk/glide/load/resource/drawable/ResourceDrawableDecoder;->handles(Landroid/net/Uri;Lcom/netease/ntunisdk/glide/load/Options;)Z
